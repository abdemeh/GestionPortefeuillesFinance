                ...
                <div className="d-flex align-items-center flex-wrap gap-2 justify-content-between mb-20">
                    ...
                    <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div className="flex-grow-1">
                                <Link to='/marketplace-details'><h6 className="text-md mb-0">Bitcoin</h6></Link>
                            </div>
                        </div>
                    ...
                    <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            />
                            <div className="flex-grow-1">
                            <Link to='/marketplace-details'><h6 className="text-md mb-0">Ethereum</h6></Link>
                            </div>
                        </div>
                        <h6 className="text-md fw-medium mb-0">$55,000.00</h6>
                    ...
                    <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            />
                            <div className="flex-grow-1">
                                <Link to='/marketplace-details'><h6 className="text-md mb-0">Solana</h6></Link>
                            </div>
                        </div>
                        <h6 className="text-md fw-medium mb-0">$55,000.00</h6>
                        <span className="text-success-main text-md fw-medium">
